...
const HeroBanner: React.FC = () => {
  return (
    <div className="pb-20 pt-36">
      ...
      <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.03] bg-grid-black/[0.2] top-0 left-0 absolute flex items-center justify-center">
