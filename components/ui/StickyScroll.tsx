...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="h-[20rem] scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 overflow-y-auto flex justify-center relative space-x-10 rounded-md p-10"
      ref={ref}
